...
function Hero(){
    return (
        <div className="container">
            <div className="row mb-5" style={{marginTop: "6rem"}}>
                <h1 className="mt-5 fs-2 text-center">We pioneered the discount broking model in India. <br />
                Now, we are breaking ground with our technology.</h1>
            </div>

            <div className="row mt-5 mb-5 text-muted" style={{lineHeight: "1.8",fontSize: "1.1em"}}>
